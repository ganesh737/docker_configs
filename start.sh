...
usage() {
  ...
  echo "-y|-j Use yocto-build-env/nodejs-env container(y is the default value)"
...
# TODO: Configure the propoer container for run_additional_instance
...
# TODO: Configure proper user and home path so that it does not conflict for nodejs and yocto
